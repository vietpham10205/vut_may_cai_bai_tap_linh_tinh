...
{
	if(head_list1 == NULL) return head_list2; 
	if(head_list2 == NULL) return head_list1; 

		if(head_list1->data > head_list2->data) swap(head_list1,head_list2);
		SinglyLinkedListNode* res =head_list1 ;
		while(head_list1 != NULL && head_list2 != NULL) {
 
            SinglyLinkedListNode* temp = NULL;

            while(head_list1 != NULL && head_list1->data <= head_list2->data) {
